              ...
              <div className="footer__contact mb-5">
                ...
                <ul class={`${styles.footer__list} ps-0 mb-0`}>
                  <li class={`${styles.footer__item}`}>
                    <a
                      href="mailto:omar.hossam.eldin98@gmail.com"
                      class={`${styles.footer__link}`}
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
                        class={`${styles.footer__linkGmail} me-1`}
                        viewBox="0 0 30 30"
                        width="30px"
                        height="30px"
                      >
                  ...
                  <li class={`${styles.footer__item}`}>
                    <a
                      href="https://www.linkedin.com/in/omar-hossam-837189256/"
                      class={`${styles.footer__link}`}
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
                        class={`${styles.footer__linkLinkedIn} me-1`}
                        viewBox="0 0 50 50"
                        width="30px"
                        height="30px"
                      >
                  ...
                  <li class={`${styles.footer__item}`}>
                    <a
                      href="https://github.com/omarhossam110"
                      class={`${styles.footer__link}`}
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
                        class={`${styles.footer__linkGitHup} me-1`}
                        viewBox="0 0 100 100"
                        width="35px"
                        height="35px"
                      >
            ...
            >
              <div class={`${styles.footer__copyright}`}>
                ...
                <p class="footer__copyright-p">
                  ...
                  <a
                    href="https://www.linkedin.com/in/omar-hossam-837189256/"
                    class={`${styles.footer__link} ${styles.footer__linkGitHup}`}
                    style={{color:"#ffca2c"}}
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  <a
                    href="https://omarhossam-portfolio.netlify.app/"
                    class={`${styles.footer__link} ${styles.footer__linkGitHup}`}
                    style={{color:"#ffca2c"}}
                    target="_blank"
                    rel="noreferrer"
